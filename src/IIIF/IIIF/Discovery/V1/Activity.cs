...
public class ActivityObject : IService
{
    ...
    [JsonProperty(Order = 3)] public string? Type { get; set; }

    [JsonProperty(Order = 4)] public string? Canonical { get; set; }

    [JsonProperty(Order = 10)] public List<ExternalResource>? SeeAlso { get; set; }

    [JsonProperty(Order = 11)] public List<Agent>? Provider { get; set; }
}
