...
public class SizeTests
{
    ...
    [Theory]
    [MemberData(nameof(ConfineDataSquare))]
    ...
    public void FitWithin_Returns_CorrectSize(int w, int h, int targetWidth, int targetHeight, int expectedWidth,
        int expectedHeight)
    {
        // Arrange 
